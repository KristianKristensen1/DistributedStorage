...
_STOREDATA_REQUEST_RANDOM_NODE = _descriptor.Descriptor(
    name='storedata_request_random_node',
    full_name='storedata_request_random_node',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='storage_node', full_name='storedata_request_random_node.storage_node', index=0,
            number=1, type=9, cpp_type=9, label=1,
            has_default_value=False, default_value=b"".decode('utf-8'),
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['storedata_request_random_node'] = _STOREDATA_REQUEST_RANDOM_NODE
...
storedata_request_random_node = _reflection.GeneratedProtocolMessageType('storedata_request_random_node',
                                                                         (_message.Message,), {
                                                                             'DESCRIPTOR': _STOREDATA_REQUEST_RANDOM_NODE,
                                                                             '__module__': 'messages_pb2'
                                                                             # @@protoc_insertion_point(class_scope:storedata_request_random_node)
                                                                         })
_sym_db.RegisterMessage(storedata_request_random_node)
